/*
  ...
  - Added the required column `professional_id` to the `bookings` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_bookings" ("barbershop_id", "client_id", "created_at", "end_date", "id", "observations", "service_id", "start_date") SELECT "barbershop_id", "client_id", "created_at", "end_date", "id", "observations", "service_id", "start_date" FROM "bookings";
DROP TABLE "bookings";
